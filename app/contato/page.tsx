    ...
    <div className="min-h-screen w-full bg-[#B1DABB] flex items-center justify-center px-4 py-12 md:px-20">
      <div className="bg-white/90 backdrop-blur-md shadow-2xl rounded-3xl p-8 md:p-12 max-w-5xl w-full space-y-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-6 text-green-900 text-lg">
          <h1 className="text-4xl md:text-5xl font-bold text-green-950">
            Contato
          </h1>
          <div className="space-y-3">
            ...
            <p className="flex items-center gap-2"><FaPhoneAlt className="text-green-800" /> (55) 3220-8973</p>
            <p className="flex items-center gap-2"><FaPhoneAlt className="text-green-800" /> (55) 99193-8183</p>
            <p className="flex items-center gap-2">
              <FaEnvelope className="text-green-800" />
              <a href="mailto:jardimbotanico@ufsm.br" className="underline hover:text-green-700 transition">
                jardimbotanico@ufsm.br
              </a>
            </p>

            <p><strong>Funcionamento:</strong><br />
            Segunda à Sexta: 8:30h - 12h, 13:30h - 17h</p>
          </div>
