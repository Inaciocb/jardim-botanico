  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center">
      <section className="min-h-screen w-full bg-[#B1DABB] flex items-center justify-center px-4 md:px-20">
        <div className="flex flex-col md:flex-row items-start gap-8 max-w-6xl">
          ...
          <div className="space-y-4 text-lg text-green-900 leading-relaxed text-justify max-w-3xl">
            ...
            <strong>Benardete de Fátima Panno</strong> – Técnica de Laboratório – Área Biologia<br></br><strong>Daniele Rodrigues</strong> –
              Técnica de Laboratório – Área Biologia.
            </p>
            ...
            <hr></hr> 
            <p>
              <strong>Agendamentos de visitas escolares ou grupos (durante período letivo) pelo formulário:{" "}
              </strong>
              <a
      ...
      <section className="min-h-screen w-full bg-[#4E9860] flex items-center justify-center px-4 md:px-20">
        ...
        <ul className="list-disc list-inside space-y- text-lg text-green-950 leading-relaxed max-w-xl text-justify">
      ...
      <section className="min-h-screen w-full bg-[#1B582A] flex items-center justify-center px-4 md:px-20">
        ...
        <img
          ...
          className="w-[65%] h-auto rounded-[36] drop-shadow-[0_8px_16px_rgba(0,0,0,0.3)]"
        />
